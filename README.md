...
In this study, I will compare the safety rating between the MechaCar and its competition.  My hypothesis is that the MechaCar will have a safety rating that is at least 10% higher than its competition.  Therefore my null hypothesis would be that the MechaCar does not have a higher safety rating than its competition.    
